# Blinded CT Validation Tool

A specialized web application designed for expert validation of CT image synthesis. This tool facilitates a double-blind study where experts evaluate the authenticity of synthetic CT images against acquired ground truth data.
...
### Option A: Hybrid (Recommended for Large CT Sets)
...
1.  **Host the App**:
    ...
    -   You get a public link (e.g., `https://ct-validator.netlify.app`).
